...
//go:generate goexec -quiet "err := vfsgen.Generate(http.Dir(\"octicons/octicons-4.2.0/build/font\"), vfsgen.Options{PackageName: \"octicons\", VariableName: \"Assets\", VariableComment: \"Assets provides GitHub Octicons data.\"}); if err != nil { log.Fatalln(err) }"
