...
//go:generate curl -L -O https://github.com/github/octicons/releases/download/v3.4.1/octicons.zip
...
//go:generate goexec -quiet "err := vfsgen.Generate(http.Dir(\"octicons\"), vfsgen.Options{PackageName: \"octicons\", VariableName: \"Assets\"}); if err != nil { log.Fatalln(err) }"
